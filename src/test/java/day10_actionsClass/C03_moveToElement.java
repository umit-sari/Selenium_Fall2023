...
public class C03_moveToElement extends TestBase {
    ...
    public void test01(){
        /*
            ...
            AMA kullanilamiyor acilir menuyu acmadan elementleri kullanmaya kalkisinca
            ElementNotInteractableException veriyor.
         */

       // 1- https://www.amazon.com/ adresine gidin
        driver.get("https://www.amazon.com");
       // 2- Sag ust bolumde bulunan “Account & Lists” menusunun acilmasi icin mouse’u
        // bu menunun ustune getirin
        Actions actions=new Actions(driver);
        WebElement listsElementi=driver.findElement(By.xpath("//*[@id='nav-link-accountList']"));
